...
const About = ({ about }: { about: aboutType | undefined }) => {
  const skillsNames = ["Problem solving", "JavaScript", "REST API", "TypeScript", "React", "React Router", "Redux", "Next.js", "SCSS", "Git", "GitHub", "C++", "Npm", "Yarn", "Figma", "Microsoft Offce", "iWork", "Photoshop", "PremierePro", "AfterEffects"]
